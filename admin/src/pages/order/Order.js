          ...
          >
            <Card.Body className="pt-0">
              <Table hover className="user-table align-items-center">
                ...
                <tbody>
                  {orders &&
                    orders.data.map((orderItem, index) => {
                      return (
                        <TableItem
                          index={index + 1}
                          order={orderItem}
            ...
            <Card.Footer className="border-0 d-lg-flex align-items-center justify-content-between">
              ...
              <small className="fw-bold">
                ...
                trong tổng số <b>{orders.total}</b> mục
              </small>
            </Card.Footer>
          </Card>
        </Row>
...
function TableItem({ index, order, routerDetailOrder, search, locationData }) {
  ...
  const handleCloseShipper = () => setShowShipper(false);
  ...
  let deleteOrder = () => {
    request({
      ...
      .then(() => {
        search("");
        addToast("Xóa đơn hàng thành công!", {
          appearance: "success",
          autoDismiss: 1000,
        });
      })
        ...
        <td>
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={() => setShowShipper(true)}>
                <FontAwesomeIcon icon={faEdit} className="me-2" /> Chọn shipper
              </Dropdown.Item>
              <Dropdown.Item
