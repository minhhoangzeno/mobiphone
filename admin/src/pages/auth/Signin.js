...
import BgImage from "../../assets/bg_1.jpeg";
      ...
      .then((result) => {
        axios({
          ...
          .then((account) => {
            ...
            if (
              account.data.roles?.[0]?.name == "SUPERADMIN" ||
              account.data.roles?.[0]?.name == "ADMIN"
            ) {
              ...
              addToast("Bạn không có quyền truy cập trang web này!", {
                appearance: "info",
                autoDismiss: 1000,
              });
            }
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                          <InputGroup>
                            <InputGroup.Text
                              style={{
                                borderColor:
                                  errors.password?.type === "required" && "red",
                              }}
                            >
