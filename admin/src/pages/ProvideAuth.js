...
import ShipperAdd from "./shipper/ShipperAdd";
import ShipperEdit from "./shipper/ShipperEdit";
...
export default function ProvideAuth() {
  return (
    <Switch>
      ...
      <RouteWithSidebar
        exact
        path={Routes.CategoryProduct.path}
        component={CategoryProduct}
      />
      <RouteWithSidebar
        exact
        path={Routes.CategoryProductAdd.path}
        component={CategoryProductAdd}
      />
      <RouteWithSidebar
        exact
        path={Routes.CategoryProductEdit.path}
      ...
      <RouteWithSidebar
        exact
        path={Routes.FeedbackDetail.path}
      ...
      <RouteWithSidebar
        exact
        path={Routes.BannerAdd.path}
        component={BannerAdd}
      />

      {/* fee */}
      <RouteWithSidebar exact path={Routes.Fee.path} component={Fee} />
      <RouteWithSidebar exact path={Routes.FeeAdd.path} component={FeeAdd} />
      <RouteWithSidebar exact path={Routes.FeeEdit.path} component={FeeEdit} />

      {/* comment */}
      <RouteWithSidebar exact path={Routes.Comment.path} component={Comment} />

      {/* shipper */}
      <RouteWithSidebar exact path={Routes.Shipper.path} component={Shipper} />
      <RouteWithSidebar
        exact
        path={Routes.ShipperAdd.path}
        component={ShipperAdd}
      />
      <RouteWithSidebar
        exact
        path={Routes.ShipperEdit.path}
